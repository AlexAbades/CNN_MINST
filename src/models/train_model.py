...
def train(lr:float, ep:int, optimizer=None) -> None:
    """Trains the network, you can change the learning rate and the number of epochs.
    ARGUMENTS
    ---------
    lr -> learning rate
    ep -> number of epochs
    optimizer -> The optimizer you want to use for the NN. By default ADAM

    RETURNS
    -------
    It saves a model in: /models/mnist/trained_model-
    """
